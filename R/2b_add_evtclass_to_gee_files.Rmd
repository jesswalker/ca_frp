...
joined_file <- files_w_fire_info %>% left_join(select(files_w_evt_info, MaxFRP, index, sample, satellite, pixelarea, starts_with("class")), by = c("index", "MaxFRP", "sample", "satellite", "pixelarea"))
