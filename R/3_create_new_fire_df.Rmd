...
#load(file.path(path_data,'processed_data_prior_to_new_df.RData'))
load(file.path(path_data,'data_from_script2.RData'))
...
save(x_fires_noevt, x_classes, file = file.path(path_in, "R", "code4_output.Rdata")) 
