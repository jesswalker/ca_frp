...
all_fires <- rbind(lst_fireslte10000, lst_fireslte20000, lst_firesgt20000)
...
save(x_fires_noevt, x_classes, file = file.path(path_in, "R", "test_of_slim_code4_output.Rdata"))
