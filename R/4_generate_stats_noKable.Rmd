...
####_4_generate_stats_noKable.Rmd_

This script generates stats based on previously processed data. Given the difficulty in  
loading kableExtra on Pangeo, that library is not used.

_Input files_:  data_from_script3.RData

_Output file_:  data_from_script4_nk.RData
...
names(evt_classes) <- c('group_desc', 'group', 'desc', 'evt_number', 'color', 'legend', 'description', 'isautoname'))  
