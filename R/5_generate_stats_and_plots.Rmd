---
title:  "Generate fire stats and data"
author: "JJWalker"
date: "2021-08-25"
output:
  html_notebook:
...
_Input files_:  processed_data_after_creating_new_df.RData
...
# ---------------------------------------------------------------- #
  ...
  x.fires.evt <- merge(x.fires.evt, evt_classes, by.x = "max_evt_cat", by.y = "evt_number")
