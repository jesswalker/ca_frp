...
# ---------------------------------------------------------------- #
  x_in <- files_all %>% 
                select(index,  MaxFRP.x, latitude, longitude, ALARM_DATE,
                       sample, satellite, newdate, pixelarea, YEAR_, FID_firep2, FIRE_NAME, GIS_ACRES, starts_with('class')) 
...
# Rename columns  
  oldnames = c("index","MaxFRP.x", "newdate", "ALARM_DATE", "YEAR_", "FID_firep2", "FIRE_NAME", "GIS_ACRES", "latitude", "longitude", "pixelarea")
