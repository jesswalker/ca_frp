...
source(file.path(path.in, "R", "ca_functions.R"))
```
...
# Get the relevant filenames
  ...
  files_all <- read.csv(file.path(path.data, "maxFRP_CA_gte4sqkm_2014to2020_fireInfo_evtClasses.csv"), header = T)
